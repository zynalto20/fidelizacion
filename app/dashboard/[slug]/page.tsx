        ...
        <div className="flex gap-2 mb-8">
          {['inicio', 'reservas', 'ajustes'].map(v => (
            <button
              ...
              className="flex-1 py-2 rounded-xl text-xs tracking-widest uppercase transition-colors"
              style={{
                background: vista === v ? primario : 'transparent',
                color: vista === v ? botonTexto : `${texto}60`,
                border: vista === v ? 'none' : `1px solid ${texto}30`
              }}
            >
              {v}
            </button>
          ...
          <>
            <div className="grid grid-cols-3 gap-3 mb-8">
              {[
                ...
                { label: 'Sellos', value: stats.sellos },
                { label: 'Canjes', value: stats.canjes },
              ].map(({ label, value }) => (
            ...
            <div className="rounded-xl p-5 mb-4" style={{ border: `1px solid ${texto}20` }}>
              ...
              <button onClick={() => setVista('reservas')} className="w-full mt-3 text-xs tracking-widest uppercase" style={{ color: `${texto}40` }}>
                Ver todas →
              </button>
            </div>
          </>
                  ...
                  <div className="flex gap-2">
                    ...
                    {r.estado !== 'cancelada' && (
                      <button
                        ...
                        className="flex-1 text-xs font-semibold rounded-lg py-2"
                        style={{ border: `1px solid ${texto}30`, color: `${texto}60`, background: 'transparent' }}
                      >
                        Cancelar
                      </button>
                    )}
        ...
        {vista === 'ajustes' && (
          <div>
            ...
            <button
              ...
              disabled={guardando}
              className="w-full font-semibold rounded-xl py-4 disabled:opacity-30 mb-4"
              style={{ background: boton, color: botonTexto }}
            >
