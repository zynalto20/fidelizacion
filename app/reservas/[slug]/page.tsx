          ...
          <div>
            ...
            <div className="mb-8">
              ...
              {serviciosNegocio.length === 0 ? (
                <p className="text-sm" style={{ color: textoSec }}>Sin servicios todavía. Añade los servicios que ofreces.</p>
              ) : (
                serviciosNegocio.map(s => (
                  <div key={s.id} className="rounded-xl p-4 mb-3" style={{ border: `1px solid ${editandoServicioNegocioId === s.id ? primario : borde}`, opacity: s.activo ? 1 : 0.5 }}>
                    <div className="flex justify-between items-center">
                      ...
                      <div className="flex gap-2 items-center">
                        <button onClick={() => toggleActivoServicioNegocio(s)} className="text-xs px-2 py-1 rounded-lg" style={{ color: s.activo ? primario : textoSec, border: `1px solid ${s.activo ? primario : borde}` }}>
